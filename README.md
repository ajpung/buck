...
# Introduction
BUCK is an Artificial Intelligence (AI) tool for predicting the age of male whitetail deer based on trail camera and jawbone imagery.

# Buck age analysis 
## Introduction
There are two main ways to predict the age a male whitetail deer: teeth and body shape.  Looking at the teeth structure and analyze their  wear and material patterning, but this requires the aid of a professional. Other techniques have been deeply investigated including antler characteristics (mass, length, etc.) as well as body proportions.
...
Results for CNN-based jawbone aging have been submitted to bioRxiv. A follow-up summary publication was recently submitted to a journal, Machine Learning: Earth. The project has also received interest from state and international agencies.
