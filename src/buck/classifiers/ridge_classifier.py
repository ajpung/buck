...
def example_usage():
    """Example of how to use the optimized Ridge Classifier function"""
    ...
    # Scale the data (important for Ridge regression)
    ...
    print("Starting Ridge Classifier optimization...")

    # Run optimization
    best_opts, best_acc, best_f1, acc_history, f1_history = _optimize_ridge_classifier(
    ...
    final_model = RidgeClassifier(**best_opts)
