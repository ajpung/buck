...
For live deer, wildlife professionals and outdoor enthusiasts rely on "aging on the hoof" (AOTH), a set of guidelines to visually assess body proportions, antler characteristics, and behavior from trail camera images or field observations. First documented in 1978 \cite{1978knowlton}, AOTH attempts to predict deer age based on morphological features including chest depth, stomach sag, neck thickness, and leg proportions \cite{1996kroll, 1999demarais, 2003richards, 2008hellickson}. Despite extensive training materials, however, human accuracy remains problematic -- in an extensive study on AOTH accuracy, Gee et al. \cite{2013gee} found wildlife enthusiasts and trained professionals achieved only $36\%$ age prediction accuracy in systematic testing with individual scores ranging between $16-56\%$. In the smaller dataset collected for this study (summarized in Figure \ref{fig:human-prediction}), average human prediction accuracy was found to be slightly higher at $60.6\%$ \cite{2025pung}. Both studies further found that prediction accuracy decreases as the age of the buck increases, and neither group achieved the $70\%$ threshold professionals themselves identify as necessary for management decisions much less the $80\%$ threshold required for research applications \cite{2013gee}.

\begin{figure}[htbp!]
\centering
\includegraphics[width=\linewidth]{images/Fig0_HumanConfusionMatrix.jpg}
