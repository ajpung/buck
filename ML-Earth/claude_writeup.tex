...
Following a preliminary evaluation of traditional methods and $>60$ traditional ML architectures and alternative CNNs (EfficientNet \cite{2020tan}, DenseNet \cite{2017huang}), ResNet-18 \cite{2015he} was selected based on held-out test accuracy.

\begin{figure}[h! tbp]
\centering
\includegraphics[width=\textwidth]{images/Fig4_ResNet18Model.jpg}
\caption{Human prediction accuracy for each age class are presented in the form of (left) a bar chart, and (right) a confusion matrix.}
\label{fig:human_accuracy_per_class}
\end{figure}
